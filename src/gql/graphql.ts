...
export type AssetCreateInput = {
  ...
  iconCta?: InputMaybe<CtaCreateManyInlineInput>;
...
export type AssetUpdateInput = {
  ...
  height?: InputMaybe<Scalars['Float']>;
  iconCta?: InputMaybe<CtaUpdateManyInlineInput>;
...
export type BlogModel = Node & {
  __typename?: 'BlogModel';
  content: BlogModelContentRichText;
  /** The time the document was created */
  createdAt: Scalars['DateTime'];
  /** User that created this document */
  createdBy?: Maybe<User>;
  /** Get the document in other stages */
  documentInStages: Array<BlogModel>;
  /** List of BlogModel versions */
  history: Array<Version>;
  /** The unique identifier */
  id: Scalars['ID'];
  /** The time the document was published. Null on documents in draft stage. */
...
/** This model can be used, for example, as a simple form on a website, app, database with several text fields already added. */
export type BlogModelCreatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};
...
/** This model can be used, for example, as a simple form on a website, app, database with several text fields already added. */
export type BlogModelDocumentInStagesArgs = {
  includeCurrent?: Scalars['Boolean'];
  inheritLocale?: Scalars['Boolean'];
  stages?: Array<Stage>;
};
...
/** This model can be used, for example, as a simple form on a website, app, database with several text fields already added. */
export type BlogModelHistoryArgs = {
  limit?: Scalars['Int'];
  skip?: Scalars['Int'];
  stageOverride?: InputMaybe<Stage>;
};
...
/** This model can be used, for example, as a simple form on a website, app, database with several text fields already added. */
export type BlogModelPublishedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};
...
/** This model can be used, for example, as a simple form on a website, app, database with several text fields already added. */
export type BlogModelScheduledInArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
...
/** This model can be used, for example, as a simple form on a website, app, database with several text fields already added. */
export type BlogModelUpdatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};

export type BlogModelConnectInput = {
  /** Allow to specify document position in list of connected documents, will default to appending at end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Document to connect */
...
/** A connection to a list of items. */
export type BlogModelConnection = {
  __typename?: 'BlogModelConnection';
  aggregate: Aggregate;
  /** A list of edges. */
  edges: Array<BlogModelEdge>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};

export type BlogModelContentRichText = {
  __typename?: 'BlogModelContentRichText';
  ...
  references: Array<BlogModelContentRichTextEmbeddedTypes>;
  /** Returns plain-text contents of RichText */
  text: Scalars['String'];
};


export type BlogModelContentRichTextReferencesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type BlogModelContentRichTextEmbeddedTypes = Asset;

export type BlogModelCreateInput = {
...
export type BlogModelCreateManyInlineInput = {
  /** Connect multiple existing BlogModel documents */
  connect?: InputMaybe<Array<BlogModelWhereUniqueInput>>;
  /** Create and connect multiple existing BlogModel documents */
  create?: InputMaybe<Array<BlogModelCreateInput>>;
};

export type BlogModelCreateOneInlineInput = {
  /** Connect one existing BlogModel document */
  connect?: InputMaybe<BlogModelWhereUniqueInput>;
  /** Create and connect one BlogModel document */
  create?: InputMaybe<BlogModelCreateInput>;
};

/** An edge in a connection. */
export type BlogModelEdge = {
  __typename?: 'BlogModelEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String'];
  /** The item at the end of the edge. */
  node: BlogModel;
...
/** Identifies documents */
export type BlogModelManyWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<BlogModelWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<BlogModelWhereInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<BlogModelWhereInput>>;
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars['String']>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  ...
  createdAt_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']>>>;
  createdBy?: InputMaybe<UserWhereInput>;
  documentInStages_every?: InputMaybe<BlogModelWhereStageInput>;
  documentInStages_none?: InputMaybe<BlogModelWhereStageInput>;
  documentInStages_some?: InputMaybe<BlogModelWhereStageInput>;
  id?: InputMaybe<Scalars['ID']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
...
export enum BlogModelOrderByInput {
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
...
export type BlogModelUpdateInput = {
...
export type BlogModelUpdateManyInlineInput = {
  /** Connect multiple existing BlogModel documents */
  connect?: InputMaybe<Array<BlogModelConnectInput>>;
  /** Create and connect multiple BlogModel documents */
  create?: InputMaybe<Array<BlogModelCreateInput>>;
  /** Delete multiple BlogModel documents */
  delete?: InputMaybe<Array<BlogModelWhereUniqueInput>>;
  /** Disconnect multiple BlogModel documents */
  disconnect?: InputMaybe<Array<BlogModelWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing BlogModel documents */
  set?: InputMaybe<Array<BlogModelWhereUniqueInput>>;
  /** Update multiple BlogModel documents */
  update?: InputMaybe<Array<BlogModelUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple BlogModel documents */
  upsert?: InputMaybe<Array<BlogModelUpsertWithNestedWhereUniqueInput>>;
};

export type BlogModelUpdateManyInput = {
  content?: InputMaybe<Scalars['RichTextAST']>;
  subtitle?: InputMaybe<Scalars['String']>;
  title?: InputMaybe<Scalars['String']>;
};

export type BlogModelUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: BlogModelUpdateManyInput;
  /** Document search */
  where: BlogModelWhereInput;
};

export type BlogModelUpdateOneInlineInput = {
  /** Connect existing BlogModel document */
  connect?: InputMaybe<BlogModelWhereUniqueInput>;
  /** Create and connect one BlogModel document */
  create?: InputMaybe<BlogModelCreateInput>;
  /** Delete currently connected BlogModel document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected BlogModel document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single BlogModel document */
  update?: InputMaybe<BlogModelUpdateWithNestedWhereUniqueInput>;
  /** Upsert single BlogModel document */
  upsert?: InputMaybe<BlogModelUpsertWithNestedWhereUniqueInput>;
};

export type BlogModelUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
  data: BlogModelUpdateInput;
  /** Unique document search */
  where: BlogModelWhereUniqueInput;
};

export type BlogModelUpsertInput = {
  /** Create document if it didn't exist */
  create: BlogModelCreateInput;
  /** Update document if it exists */
  update: BlogModelUpdateInput;
};

export type BlogModelUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: BlogModelUpsertInput;
  /** Unique document search */
  where: BlogModelWhereUniqueInput;
};

/** This contains a set of filters that can be used to compare values internally */
export type BlogModelWhereComparatorInput = {
  /** This field can be used to request to check if the entry is outdated by internal comparison */
  outdated_to?: InputMaybe<Scalars['Boolean']>;
};

/** Identifies documents */
export type BlogModelWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<BlogModelWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<BlogModelWhereInput>>;
...
/** The document in stages filter allows specifying a stage entry to cross compare the same document between different stages */
export type BlogModelWhereStageInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<BlogModelWhereStageInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<BlogModelWhereStageInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<BlogModelWhereStageInput>>;
  /** This field contains fields which can be set as true or false to specify an internal comparison */
  compareWithParent?: InputMaybe<BlogModelWhereComparatorInput>;
  /** Specify the stage to compare with */
  stage?: InputMaybe<Stage>;
};

/** References BlogModel record uniquely */
export type BlogModelWhereUniqueInput = {
  id?: InputMaybe<Scalars['ID']>;
  slug?: InputMaybe<Scalars['String']>;
};
...
export type Mutation = {
  ...
  deleteBlogModel?: Maybe<BlogModel>;
  ...
  /**
   * Delete many BlogModel documents
   * @deprecated Please use the new paginated many mutation (deleteManyBlogModelsConnection)
   */
  ...
  publishBlogModel?: Maybe<BlogModel>;
  /** Publish one hero */
   ...
   * @deprecated Please use the new paginated many mutation (publishManyBlogModelsConnection)
   */
  ...
  /** Unpublish one blogModel from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  unpublishBlogModel?: Maybe<BlogModel>;
  /** Unpublish one hero from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  ...
  /**
   * Unpublish many BlogModel documents
   * @deprecated Please use the new paginated many mutation (unpublishManyBlogModelsConnection)
   */
  ...
  updateBlogModel?: Maybe<BlogModel>;
  /** Update one hero */
  ...
  /**
   * Update many blogModels
   * @deprecated Please use the new paginated many mutation (updateManyBlogModelsConnection)
   */
...
export type MutationCreateBlogModelArgs = {
  data: BlogModelCreateInput;
};
...
export type MutationDeleteBlogModelArgs = {
  where: BlogModelWhereUniqueInput;
};
...
export type MutationDeleteManyBlogModelsArgs = {
  where?: InputMaybe<BlogModelManyWhereInput>;
};


export type MutationDeleteManyBlogModelsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type MutationPublishBlogModelArgs = {
  to?: Array<Stage>;
  where: BlogModelWhereUniqueInput;
};
...
export type MutationPublishManyBlogModelsArgs = {
  to?: Array<Stage>;
  where?: InputMaybe<BlogModelManyWhereInput>;
};


export type MutationPublishManyBlogModelsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: InputMaybe<Stage>;
...
export type MutationSchedulePublishBlogModelArgs = {
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  to?: Array<Stage>;
  where: BlogModelWhereUniqueInput;
...
export type MutationScheduleUnpublishBlogModelArgs = {
  from?: Array<Stage>;
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  where: BlogModelWhereUniqueInput;
...
export type MutationUnpublishBlogModelArgs = {
  from?: Array<Stage>;
  where: BlogModelWhereUniqueInput;
};
...
export type MutationUnpublishManyBlogModelsArgs = {
  from?: Array<Stage>;
  where?: InputMaybe<BlogModelManyWhereInput>;
};


export type MutationUnpublishManyBlogModelsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: Array<Stage>;
...
export type MutationUpdateBlogModelArgs = {
  data: BlogModelUpdateInput;
  where: BlogModelWhereUniqueInput;
};
...
export type MutationUpdateManyBlogModelsArgs = {
  data: BlogModelUpdateManyInput;
  where?: InputMaybe<BlogModelManyWhereInput>;
};


export type MutationUpdateManyBlogModelsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  data: BlogModelUpdateManyInput;
  first?: InputMaybe<Scalars['Int']>;
...
export type Query = {
  ...
  /** Retrieve a single blogModel */
  blogModel?: Maybe<BlogModel>;
  /** Retrieve document version */
  blogModelVersion?: Maybe<DocumentVersion>;
  /** Retrieve multiple blogModels */
  blogModels: Array<BlogModel>;
  /** Retrieve multiple blogModels using the Relay connection interface */
  blogModelsConnection: BlogModelConnection;
...
export type QueryBlogModelArgs = {
  locales?: Array<Locale>;
  stage?: Stage;
  where: BlogModelWhereUniqueInput;
};
...
export type QueryBlogModelVersionArgs = {
  where: VersionWhereInput;
};


export type QueryBlogModelsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  locales?: Array<Locale>;
  orderBy?: InputMaybe<BlogModelOrderByInput>;
  skip?: InputMaybe<Scalars['Int']>;
  stage?: Stage;
  where?: InputMaybe<BlogModelWhereInput>;
};


export type QueryBlogModelsConnectionArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type ScheduledOperationAffectedDocument = Asset | BlogModel | Hero | Sidebar;
...
export type HeroQuery = { __typename?: 'Query', heroes: Array<{ __typename?: 'Hero', title?: string | null, description?: { __typename?: 'RichText', html: string } | null, cta?: { __typename?: 'Cta', text?: string | null, icon?: { __typename?: 'Asset', id: string } | null } | null }> };
...
export const HeroDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Hero"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"title"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"heroes"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"title"},"value":{"kind":"Variable","name":{"kind":"Name","value":"title"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"html"}}]}},{"kind":"Field","name":{"kind":"Name","value":"cta"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"text"}},{"kind":"Field","name":{"kind":"Name","value":"icon"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]}}]} as unknown as DocumentNode<HeroQuery, HeroQueryVariables>;